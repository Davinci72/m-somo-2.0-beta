<?php
//On index.php these are the required initializations : 
 error_reporting(E_ALL & ~E_NOTICE); //For debugging. comment on production environment
 //require ('auth/auth.php'); //required for protected pages
//session variables. Derived from table users, one can add fields here than can be accessed globaly and initialize them on auth/login-exec.php
//  $member = "";
...
<!-- Mirrored from themicon.co/theme/angle/v3.5/backend-jquery/app/template.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 06:28:42 GMT -->
<head>
   <meta charset="utf-8">
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
   <meta name="description" content="Bootstrap Admin App + jQuery">
   <meta name="keywords" content="app, responsive, jquery, bootstrap, dashboard, admin">
   <title>Titan - For Schools</title>
   <!-- =============== VENDOR STYLES ===============-->
   <!-- FONT AWESOME-->
   ...
   <!-- =============== BOOTSTRAP STYLES ===============-->
   <link rel="stylesheet" href="temp/css/bootstrap.css" id="bscss">
   <!-- =============== APP STYLES ===============-->
   <link rel="stylesheet" href="temp/css/app.css" id="maincss">
   <link rel="stylesheet" href="temp/css/theme-h.css" id="maincss">
</head>

<body class="-text aside-hover show-scrollbar aside-collapsed offsidebar-open aside-collapsed-text">
   <div class="wrapper">
      <!-- top navbar-->
      <header class="topnavbar-wrapper">
         ...
         <nav role="navigation" class="navbar topnavbar">
            ...
            <div class="navbar-header">
               <a href="#/" class="navbar-brand">
                  <div class="brand-logo">
                     <img src="temp/img/logo.png" alt="App Logo" class="img-responsive">
                  </div>
                  <div class="brand-logo-collapsed">
                     <img src="temp/img/logo-single.png" alt="App Logo" class="img-responsive">
                  </div>
               </a>
            </div>
            <!-- END navbar header-->
            ...
            <!-- END Nav wrapper-->
            <!-- START Search form-->
            <form role="search" action="http://themicon.co/theme/angle/v3.5/backend-jquery/app/search.html" class="navbar-form">
         ...
         <div class="aside-inner">
            <nav data-sidebar-anyclick-close="" class="sidebar show-scrollbar">
               ...
               <ul class="nav">
                        ...
                        <div class="item user-block">
                           ...
                           <div class="user-block-picture">
                              <div class="user-block-status">
                                 <img src="temp/img/user/02.jpg" alt="Avatar" width="60" height="60" class="img-thumbnail img-circle">
                  ...
                  <li class=" ">
                     <a href="?page=students" title="Students">
                        <em class="icon-grid"></em>
                        <span>Students</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="?page=payments" title="Layouts" data-toggle="collapse">
                  ...
                  <li class=" ">
                     <a href="?page=streams" title="Elements" data-toggle="collapse">
                  ...
                  <li class=" ">
                     <a href=">page=hr" title="Charts" data-toggle="collapse">
                  ...
                  <li class=" ">
                     <a href="?page=inventory" title="Maps" data-toggle="collapse">
                     ...
                     <ul class="nav">
                        ...
                        <li>
                           ...
                           <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="temp/img/user/05.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                              <!-- Contact info-->
                           ...
                           <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="temp/img/user/06.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                              <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                           ...
                           <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="temp/img/user/07.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                              <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                           ...
                           <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="temp/img/user/08.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                              <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                        ...
                        <li>
                           ...
                           <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="temp/img/user/09.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                              <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                           ...
                           <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="temp/img/user/10.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                              <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
   ...
   <!-- RTL demo-->
   <script src="temp/js/demo/demo-rtl.js"></script>
   <!-- =============== PAGE VENDOR SCRIPTS ===============-->
   <!-- =============== APP SCRIPTS ===============-->
